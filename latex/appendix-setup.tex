...
\makeatletter
\titlecontents{chapter}[0em] %% NOTE: UF Example LaTeX pdf has the word APPENDIX indented, I was told to change it by editorial office, but if you want to get it like that, make this 2em
    {\addvspace{8pt}}
    {%
    \hspace*{0em}\hyper@linkstart{link}{\Hy@tocdestname}\hspace*{2em}\contentslabel{2em}\hyper@linkend%
    \ifchapterCapOff\else\color{blue}\uppercase\fi% Decide if we auto capitalize the chapter in TOC or not
